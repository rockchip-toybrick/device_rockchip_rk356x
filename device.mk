...
PRODUCT_COPY_FILES += \
	...
	$(LOCAL_PATH)/stressapptest:$(TARGET_COPY_OUT_VENDOR)/bin/stressapptest \
	$(LOCAL_PATH)/memtester:$(TARGET_COPY_OUT_VENDOR)/bin/memtester 
PRODUCT_COPY_FILES += \
...
PRODUCT_PROPERTY_OVERRIDES += \
				...
				vendor.hwc.device.extend=eDP,DSI \
